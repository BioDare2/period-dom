...
public class PeriodDomJSONTests {
    ...
    @Test
    public void mffPPAResultCanBeSavedAndReadFromAbstract() throws Exception {
        
        MFF_PPA org = new MFF_PPA(new PPA(24, 0.24, 5, 0.5, 10, 0.1, 1, 0.01, 0.12, 0.13, 0.14));
